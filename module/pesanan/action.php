...
if ($button == "konfirmasi") {
    ...
    $queryPembayaran = mysqli_query($koneksi, "INSERT INTO konfirmasi_pembayaran (pesanan_id, nomor_rekening, nama_account, tanggal_transfer) VALUE ('$pesanan_id', '$nomor_rekening', '$nama_account', '$tanggal_transfer')");
