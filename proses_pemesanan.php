...
if (empty($nama_penerima) || empty($nomor_telepon) || empty($alamat)) {
    if (isset($_SESSION["buyNow"])) {
        header("location: " . BASE_URL . "index.php?page=data_pemesan&notif=buyNow&notif2=require&$dataForm");
    } else {
        header("location: " . BASE_URL . "index.php?page=data_pemesan&notif2=require&$dataForm");
    }
} else {
